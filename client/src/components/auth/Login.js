...
const Login = () => {
    const { attemptLogin, userLoginDetails, userLoading, setUserLoginDetails, userErrorMessage, setUserErrorMessage, } = (0, react_1.useContext)(AuthContext_1.AuthContext);
    /*
    ...
    */
    ...
    const handleFormInput = (e) => {
        setUserLoginDetails(Object.assign(Object.assign({}, userLoginDetails), { [e.currentTarget.id]: e.currentTarget.value }));
    };
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Card_1.default, { style: {
            ...
            react_1.default.createElement(Form_1.default, { onSubmit: (e) => handleLogin(e) },
                ...
                react_1.default.createElement(Button_1.default, { type: "submit", disabled: false, size: "lg" }, "Login")))));
};
