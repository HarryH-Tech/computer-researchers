...
const AddResearcher = () => {
    const { saveResearcher, errorMessage, getAllResearchers, setErrorMessage, successMessage, } = (0, react_1.useContext)(ResearchContext_1.ResearchContext);
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Card_1.default, { style: {
            ...
            react_1.default.createElement(Card_1.default.Title, null,
                react_1.default.createElement("h1", null, "Add Researcher")),
            react_1.default.createElement(Form_1.default, { onSubmit: (e) => handleSaveResearcher(e, formData) },
                react_1.default.createElement("div", { className: "container" },
                    react_1.default.createElement("div", { className: "input-container" },
                        react_1.default.createElement("input", { onChange: handleFormInput, type: "text", id: "name", placeholder: "Name...", className: "input" })),
                    react_1.default.createElement("div", { className: "input-container" },
                        react_1.default.createElement("textarea", { 
                            //Avoids throwing error that e:FormEvent is not assignable to textarea elements
                            // @ts-expect-error
                            onChange: handleFormInput, type: "text", id: "description", placeholder: "Description...", className: "input", rows: 6 })),
                    react_1.default.createElement("div", { className: "input-container" },
                        react_1.default.createElement("input", { onChange: handleFormInput, type: "date", id: "dob", placeholder: "DOB...", className: "input" }))),
                react_1.default.createElement(Button_1.default, { type: "submit", disabled: name === '' || description === '' || dob === '' ? true : false, size: "lg" },
                    "Add Researcher ",
                    react_1.default.createElement(react_bootstrap_icons_1.PlusCircleFill, null)),
                react_1.default.createElement("br", null),
                react_1.default.createElement("br", null))),
        errorMessage && react_1.default.createElement(ErrorMessage_1.default, null),
        successMessage && react_1.default.createElement(SuccessMessage_1.default, null)));
};
